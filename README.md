...
A continuación se presentan las pantallas principales diseñadas para vista Web y Móvil, evidenciando el diseño diferenciado y los formularios exigidos (con RUT, Región, Comuna, etc.).

*![Mockup Inicio](./ruta-a-tu-imagen/inicio.png)*
*![Mockup Login/Registro](./ruta-a-tu-imagen/login.png)*
*[Agrega aquí capturas de tus otras 5 pantallas...]*

---

## 🗺️ EP 1.4: Arquitectura de Navegación y UX
...
**Justificación Técnica:** Se optó por una barra de navegación inferior (Tab bar) en la versión móvil para facilitar el acceso con el pulgar, y un menú lateral (Sidebar) en la versión de escritorio para aprovechar el espacio horizontal, garantizando coherencia y escalabilidad en ambos dispositivos.
